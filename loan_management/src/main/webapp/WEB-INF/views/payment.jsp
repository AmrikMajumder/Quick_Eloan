...
<br/>
	<div class="container">
	<h1><font color="brown">EMI Payment Page</font></h1>
		<p>
			<font color="red">${errorMessage}</font>
		</p>
		<form action="/emistatus" method="post">
			<fieldset class="form-group">
				<label>Customer ID</label> <input name="cust" type="text"
					class="form-control" />
			</fieldset>
			<fieldset class="form-group">
				<label>EMI Amount</label> <input name="amt" type="text"
					class="form-control" />
			</fieldset>
